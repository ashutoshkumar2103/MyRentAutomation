package com.myrent.tests.pages;
...
public class CreateQuotationTest extends BaseTest {
    ...
    public void createQuotationAndClose() {
        ...
        // ── Step 1: Login ─────────────────────────────────────────────────────
        getDriver().get(ConfigReader.getUrl("url.login"));
        ...
        // ── Step 2: Navigate to Create Quotation ──────────────────────────────
        CreateQuotationPage quotationPage = new CreateQuotationPage(getDriver());
        ...
        // ── Step 7: Reservation Source + Commission ───────────────────────────
        ...
        // ── Step 9: Handle modal or redirect ─────────────────────────────────
